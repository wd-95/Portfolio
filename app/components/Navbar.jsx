    ...
    >
       <div className=" text-lg w-full px-10 md:px-20 flex items-center justify-between ">
        ...
        <div className="md:hidden flex items-center gap-3">
          <button
            onClick={() => setDarkMode((prev) => !prev)}
            className="p-2 rounded-full border border-gray-500/40 text-gray-800  hover:border-teal-400 hover:text-teal-400 dark:text-gray-200 "
            aria-label="Toggle theme"
          >
            {darkMode ? <FiSun size={18} /> : <FiMoon size={18} />}
          </button>
          ...
          <button
            ...
            className="p-2 text-gray-800 z-50 dark:text-gray-200"
        ...
        <div
          className={
            "fixed inset-0 bg-gray-200/90 dark:bg-gray-900/90 backdrop-blur-md flex flex-col items-center justify-center transition-all duration-300 md:hidden " +
            (isMenuOpen
          ...
          <div className="flex flex-col space-y-8 text-xl items-center">
            {navItems.map((item) => (
              <a
                key={item.href}
                href={item.href}
                className="text-xl text-gray-800/90 dark:text-gray-200/90 hover:text-teal-400 transition-colors duration-300"
